...
#if defined(CONFIG_STM32_SPI1) || defined(CONFIG_STM32_SPI2) || defined(CONFIG_STM32_SPI3) || defined(CONFIG_STM32_SPI4) || defined(CONFIG_STM32_SPI5)
 ...
 *
 * Description:
 *   Called to configure SPI chip select GPIO pins for the stm32f411-minimum
 *   board.
 *
 ****************************************************************************/
...
{
    #if defined(CONFIG_WL_NRF24L01) || defined(CONFIG_STM32_SPI2)
